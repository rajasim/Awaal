...
function CloudIndustriel() {
  return (
    <div className="industrial-section">
      <img className="bg-image" src="/images/cloudindustries.jpg" alt="bg" />
      ...
      <div className="industrial-content">
        ...
        <div className="industries-grid">
          ...
          <div className="industry-box">
          <img src="/images/industries 8.png" alt="Hotel" />
            <h3>Real Estate</h3>
...
export default CloudIndustriel;
