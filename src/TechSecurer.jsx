  ...
  return (
    <div className="ts-container">
      ...
      <h2 className="ts-heading">
        About <span className="ts-highlight">Awwal Security</span>
      </h2>
      ...
      <div className="ts-section">
        <div className="ts-story-box">
          ...
          <p className="ts-story-text">
            We began with a clear purpose to deliver secure, reliable, and intelligent tech solutions in a digital first world. From day one, our focus has been on combining deep technical expertise with a commitment to quality, security, and innovation.
          </p>
          <p className="ts-story-text">
          Awwal Security stands as a full-scale tech solutions partner, offering everything from AI powered automation and Cloud services to Software development, IT infrastructure, Cybersecurity and Website solutions.
          </p>
          <p className="ts-story-text">
