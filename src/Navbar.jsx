  ...
  <span>CASE STUDIES</span>
              ...
              >
                <div className="mega-left">
                  <div className="mega-platform-box">
                    <h3 style={{ lineHeight: "1.5rem" }}>Awwal Platform</h3>
                    <p>
                      Driving Digital Innovation Through Smart IT and Automation
                      Solutions
                    </p>
                  </div>
                  <div className="mega-left-menu">
                    <div
                      onMouseEnter={() => setHoveredSubItem("CYBERSECURITY")}
                    >
                      CYBERSECURITY
                    </div>
                    ...
                    <div onMouseEnter={() => setHoveredSubItem("CLOUD")}>
                      CLOUD
                    </div>
                    <div onMouseEnter={() => setHoveredSubItem("SOFTWARE DEV")}>
                      SOFTWARE DEV
                    </div>
                    <div onMouseEnter={() => setHoveredSubItem("IT INFRA")}>
                      IT INFRA
                    </div>
                    <div onMouseEnter={() => setHoveredSubItem("WEBSITE DEV")}>
                      WEBSITE DEV
                    </div>
                    <div onMouseEnter={() => setHoveredSubItem("MIGRATION")}>
                      MIGRATION
                    </div>
                  </div>
                </div>
                ...
                <div className="mega-right">
                  {hoveredSubItem === "CYBERSECURITY" && (
                    <>
                      <h3>
                        Stay Secure, Stay in Control with End-to-End
                        Cybersecurity Solutions
                      </h3>
                      <p>
                        We provide complete cybersecurity solutions to protect
                        your business, detect threats in real time, and ensure
                        compliance keeping you secure and in control.
                      </p>
        ...
        FREE DEMO →
                  ...
                  {hoveredSubItem === "CLOUD" && (
                    <>
                      <h3>
                        Powerful, Secure, and Scalable Cloud Solutions Made
                        Simple
                      </h3>
                      <p>
                        We help you migrate, manage, and secure your cloud with
                        ease. We ensure your cloud setup is reliable, scalable,
                        fast, flexible, and fully protected.
                      </p>
                      <button className="plans-btnon">Services →</button>

                      <div className="links-grid" onClick={() => nav("/CLOUD")}>
        ...
        FREE DEMO →
                  ...
                  {hoveredSubItem === "AI & Automation Services" && (
                    <>
                      ...
                      <p>
                        Unlock the power of AI & Automation to accelerate
                        workflows, reduce costs, and make data driven decisions.
                      </p>
                      <button className="plans-btnon">Services →</button>
        ...
        FREE DEMO →
                  ...
                  {hoveredSubItem === "SOFTWARE DEV" && (
                    <>
                      <h3>
                        Smart, Scalable Software and App Development for Every
                        Need
                      </h3>
                      <p>
                        We design and build custom software and mobile apps that
        ...
        FREE DEMO →
                  ...
                  {hoveredSubItem === "IT INFRA" && (
                    <>
                      <h3>
                        Robust and Reliable IT Infrastructure Built for
                        Performance
                      </h3>
                      <p>
                        We build and manage reliable IT setups that power your
        ...
        FREE DEMO →
                  ...
                  {hoveredSubItem === "WEBSITE DEV" && (
                    <>
                      <h3>
                        Custom Built Websites That Elevate Your Brand and Drive
                        Results
                      </h3>
                      <p>
                        We create modern, responsive websites that are fast,
                        secure, and built to grow your business. We blend design
                        and tech to give your brand a strong online presence.
                      </p>
                      <button className="plans-btnon">Services →</button>
        ...
        FREE DEMO →
                  ...
                  {hoveredSubItem === "MIGRATION" && (
                    <>
                      <h3>
                        Seamless Data and System Migration Without Downtime
                      </h3>
                      <p>
                        We help you move your data, apps, or infrastructure to
                        new environments with zero hassle. We ensure smooth,
                        secure, and downtime-free migrations.
                      </p>
                      <button className="plans-btnon">Services →</button>
        ...
        FREE DEMO →
                  ...
                  {hoveredSubItem === "Managed XDR/MXDR" && (
                    <>
                      <h3>
                        Enhance Your Security with Advanced Detection & Response
                      </h3>
                      <p>
                        Our XDR/MXDR solutions provide real-time threat
                        detection, automated responses, and 24/7 monitoring for
                        complete protection of your infrastructure.
                      </p>
                      <button className="plans-btnon">Services →</button>
                      ...
                      >
                        ...
                        <a href="#">
                          Unified Threat Detection (Endpoint, Network, Cloud)
                        </a>
                  ...
                  {hoveredSubItem === "EDR/NGAV Protection" && (
                    <>
                      <h3>
                        Next-Gen Endpoint Security for Proactive Threat
                        Prevention
                      </h3>
                      <p>
                        Our EDR/NGAV solutions combine advanced AI-driven
                        prevention and real-time behavioral analytics to secure
                        your endpoints against modern cyber threats.
                      </p>
                      <button className="plans-btnon">Services →</button>
                      ...
                      >
                        <a href="#">
                          AI-Powered Malware & Ransomware Prevention
                        </a>
                        <a href="#">
                          Behavior-Based Threat Detection & Response
                        </a>
                        ...
                        <a href="#">
                          Centralized Visibility with Threat Intelligence
                          Integration
                        </a>
                      </div>
                  ...
                  {hoveredSubItem === "Email Protection" && (
                    <>
                      ...
                      <p>
                        Advanced email security solutions to detect, prevent,
  ...
  <div className="navbar-contact">
    ...
    <span>Customer Support</span>
      ...
      <div
        ...
        onClick={() => {
          if (centernav.current.style.display === "flex") {
