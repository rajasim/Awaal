          ...
          {isMobile && active === "network" && (
            <div className="soft-content-box">
              <div className="soft-text-section">
                ...
                <p>
                  We design and develop bespoke software systems tailored to your unique
                  workflows, customers, and market. Whether it’s ERP, CRM, or custom
                  automation tools, our team delivers user-focused and scalable solutions.
                </p>
                <ul>
          ...
          {isMobile && active === "web" && (
            <div className="soft-content-box">
              <div className="soft-text-section">
                ...
                <p>
                  Our web applications combine functional design with powerful backend
                  systems to deliver seamless user experiences across all devices and browsers.
                </p>
                <ul>
          ...
          {isMobile && active === "performance" && (
            <div className="soft-content-box">
              <div className="soft-text-section">
                ...
                <p>
                  We craft intuitive and feature-rich mobile apps for both iOS and Android,
                  optimized for performance, security, and user engagement.
                </p>
                <ul>
          ...
          {isMobile && active === "email" && (
            <div className="soft-content-box">
              <div className="soft-text-section">
                ...
                <p>
                  We build secure and well-documented APIs that power your app ecosystem.
                  Whether integrating with third-party platforms or enabling microservices,
                  we ensure seamless and secure data exchange.
                </p>
                <ul>
