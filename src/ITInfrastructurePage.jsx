...
const ITInfrastructurePage = () => {
  ...
  >
    <source src="/video/WhatsApp Video 2025-06-16 at 6.51.33 PM.mp4" type="video/mp4" />
  </video>

  <div className="infra-content">
    <div className="infra-left">
      <span className="infra-badge">Enterprise-Grade IT Infrastructure</span>
      <h1>
        Next-Generation <br />
      ...
      <p>
        Transform your business with our comprehensive IT infrastructure solutions designed
        for maximum performance, security, and scalability.
      </p>

      <div className="infra-points">
        <div className="infra-point"><span className="infra-dot" />Server Infrastructure</div>
        <div className="infra-point"><span className="infra-dot" />Network Security</div>
        <div className="infra-point"><span className="infra-dot" />Cloud Integration</div>
  ...
  <div className="infra-trusted">
    <div className="trusted-heading">Trusted by leading organizations worldwide</div>
